...
const ASHRAF_QUESTIONS = {
  "What is your name?": { 
    ...
    videoFile: "V1-0001_V1-0002_Ashraf_Full_Interview_Clipping970.mov", 
    transcript: "My name is Ashraf Manji." 
  },
  "Who is in your family?": { 
    id: 2, 
    category: "Demographics", 
    videoFile: "V1-0005_Ashraf_Full_Interview_Clipping1545.mov", 
  ...
  "Do you have a spouse or life partner? Are you married or have you been married?": { 
    id: 3, 
    category: "Demographics", 
    videoFile: "V1-0003_V1-0009_Ashraf_Full_Interview_Clipping2365.mov", 
    transcript: "I I do have a spouse.\nMy spouse's name is… Sophia Lee." 
  },
  "Where do you live?": { 
    id: 5, 
    category: "Demographics", 
    videoFile: "V1-0011_Ashraf_Full_Interview_Clipping2735.mov", 
  ...
  "What do (or did) you do for a living? What job or career did you spend the majority of your life working at?": { 
    id: 6, 
    category: "Career", 
    videoFile: "V1-0013_Ashraf_Full_Interview_Clipping3050.mov", 
  ...
  "What do you enjoy doing?": { 
    id: 7, 
    category: "Basics", 
    videoFile: "V1-0015_Ashraf_Full_Interview_Clipping3535.mov", 
  ...
  "Where did you land first in the U.S.? Where did you first arrive in the U.S.?": { 
    id: 13, 
    category: "History", 
    videoFile: "V1-0027_Ashraf_Full_Interview_Clipping6765.mov", 
  ...
  "When did you first arrive to the Midwest?": { 
    id: 14, 
    category: "History", 
    videoFile: "V1-0029_Ashraf_Full_Interview_Clipping7565.mov", 
  ...
  "What did you pursue in Northwestern University? What degree did you earn there?": { 
    id: 15, 
    category: "Education", 
    videoFile: "V1-0031_Ashraf_Full_Interview_Clipping8305.mov", 
  ...
  "What is your citizenship status? When did you become a U.S. citizen?": { 
    id: 16, 
    category: "History", 
    videoFile: "v1-0033_ashraf_full_interview_clipping8740 (online-video-cutter.com).mp4", 
  ...
  "How did you feel about initially coming to the U.S.?": { 
    id: 17, 
    category: "Arrival", 
    videoFile: "v1-0035_ashraf_full_interview_clipping9345 (online-video-cutter.com).mp4", 
  ...
  "Did you intend to stay or leave the U.S. after receiving your education here?": { 
    id: 18, 
    category: "History", 
    videoFile: "V1-0037_Ashraf_Full_Interview_Clipping11070.mov", 
  ...
  "Can you share a bit about your life before you decided to immigrate to the United States?": { 
    id: 19, 
    category: "Early Life", 
    videoFile: "V1-0040_Ashraf_Full_Interview_Clipping15390.mov", 
  ...
  "What factors influenced your decision to leave [Tanzania] and move to the U.S.?": { 
    id: 20, 
    category: "Early Life", 
    videoFile: "V1-0042_Ashraf_Full_Interview_Clipping21940.mov", 
  ...
  "What did you expect your life would be like in the United States?": { 
    id: 21, 
    category: "Arrival", 
    videoFile: "V1-0044_Ashraf_Full_Interview_Clipping25375.mov", 
  ...
  "How were you treated by Americans when you first moved to the U.S.?": { 
    id: 22, 
    category: "Arrival", 
    videoFile: "V1-0046_Ashraf_Full_Interview_Clipping27185.mov", 
  ...
  "What was a memorable experience from your early days in the United States?": { 
    id: 23, 
    category: "Arrival", 
    videoFile: "V1-0048_Ashraf_Full_Interview_Clipping32870.mov", 
  ...
  "Describe your initial experiences upon arriving in the United States. Describe your experiences with activism in the United States. Did you engage with the Civil Rights Movement, how so?": { 
    id: 24, 
    category: "Activism", 
    videoFile: "V1-0066_Ashraf_Full_Interview_Clipping82720.mp4", 
  ...
  "Did attending the March on Washington in 1963 have a lasting effect on your life? What was the racial climate like when you came to the U.S. in 1963?": { 
    id: 25, 
    category: "Activism", 
    videoFile: "V1-0052_Ashraf_Full_Interview_Clipping39240.mov", 
  ...
  "What aspects of American culture did find challenging or interesting ? How was your experience at college?": { 
    ...
    videoFile: "V1-0054_Ashraf_Full_Interview_Clipping41440.mov", 
  ...
  "What was it like to date in college in the 1960s?": { 
    id: 27, 
    category: "Social Life", 
    videoFile: "V1-0056_Ashraf_Full_Interview_Clipping47520.mov", 
  ...
  "What is a story you can tell us about someone you dated in college?": { 
    id: 28, 
    category: "Social Life", 
    videoFile: "V1-0058_Ashraf_Full_Interview_Clipping49145.mov", 
  ...
  "How has your experience been living in Illinois with your experience living in other parts of the US?": { 
    id: 29, 
    category: "History", 
    videoFile: "V1-0060_Ashraf_Full_Interview_Clipping56895.mov", 
  ...
  "Were there any differences or things you particularly enjoyed about living in the U.S. compared to your previous life in Tanzania?": { 
    id: 30, 
    category: "Social Life", 
    videoFile: "V1-0062_Ashraf_Full_Interview_Clipping61765.mov", 
  ...
  "How did you come to study in the U.S.? What were personal or global factors that allowed you the opportunity to come study in the U.S.?": { 
    id: 32, 
    category: "History", 
    videoFile: "V1-0064_Ashraf_Full_Interview_Clipping65135.mov", 
  ...
  "Are there any aspects of Indian culture or East African culture, traditions and lifestyle that you missed most coming to the U.S.? What kinds of food do you enjoy?": { 
    id: 33, 
    category: "Social Life", 
    videoFile: "V1-0086_Ashraf_Full_Interview_Clipping148495.mov", 
  ...
  "How have you maintained connections with other South Asian or Asian immigrants and did you form relationships with people from different backgrounds?": { 
    id: 34, 
    category: "Social Life", 
    videoFile: "V1-0088_Ashraf_Full_Interview_Clipping151920.mov", 
  ...
  "What type of activism or leadership have you engaged in? Why did you co-found the Asian American Institute?": { 
    id: 35, 
    category: "Activism", 
    videoFile: "V1-0090_Ashraf_Full_Interview_Clipping156715.mov", 
  ...
  "What was the hardest part of life in those early days of the institute?": { 
    id: 36, 
    category: "Activism", 
    videoFile: "V1-0092_Ashraf_Full_Interview_Clipping160335.mov", 
  ...
  "What advice would you give to future generations of immigrants pursuing their own American Dream?": { 
    id: 37, 
    category: "General", 
    videoFile: "V1-0094_Ashraf_Full_Interview_Clipping166130.mov", 
  ...
  "What challenges did you face in education?": { 
    id: 38, 
    category: "Education", 
    videoFile: "V1-0096_Ashraf_Full_Interview_Clipping170250.mov", 
  ...
  "What challenges did you face in securing or maintaining suitable housing in the U.S.?": { 
    id: 39, 
    category: "History", 
    videoFile: "V1-0098_Ashraf_Full_Interview_Clipping175760.mov", 
  ...
  "What challenges did you face in securing or maintaining suitable Housing?": { 
    id: 40, 
    category: "History", 
    videoFile: "V1-0100_Ashraf_Full_Interview_Clipping187195.mov", 
  ...
  "What challenges did you face in accessing Health care?": { 
    id: 41, 
    category: "General", 
    videoFile: "V1-0102_Ashraf_Full_Interview_Clipping194330.mov", 
  ...
  "What challenges did you face in social support?": { 
    id: 42, 
    category: "General", 
    videoFile: "V1-0104_Ashraf_Full_Interview_Clipping196040.mov", 
  ...
  "What challenges did you face with Financial needs?": { 
    id: 43, 
    category: "General", 
    videoFile: "V1-0106_Ashraf_Full_Interview_Clipping197700.mov", 
  ...
  "When and where were you born ?": { 
    id: 58, 
    category: "Demographics", 
    videoFile: "V1-0002_V1-0004_Ashraf_Full_Interview_Clipping1180.mov", 
  ...
  "How did you come to the U.S.? What was it like coming to U.S.? How were you inspired by the Civil Rights Movement?": { 
    id: 59, 
    category: "History", 
    videoFile: "V1-0068_Ashraf_Full_Interview_Clipping97570.mov", 
  ...
  "What opportunities or achievements did you experience in the U.S. that you might not have had in Tanzania?": { 
    id: 60, 
    category: "History", 
    videoFile: "V1-0070_Ashraf_Full_Interview_Clipping113050.mov", 
  ...
  "So what kind of work did you engage in when you first arrived or when you first graduated?": { 
    id: 61, 
    category: "Career", 
    videoFile: "V1-0072_Ashraf_Full_Interview_Clipping118320.mov", 
  ...
  "Were you treated fairly in terms of salary or opportunities? Did you gain recognition for your work? Did you notice or experience discrimination in the workplace?": { 
    id: 62, 
    category: "Career", 
    videoFile: "V1-0074_Ashraf_Full_Interview_Clipping125285.mov", 
  ...
  "And what advantages or disadvantages did you have professionally?": { 
    id: 63, 
    category: "Career", 
    videoFile: "V1-0076_Ashraf_Full_Interview_Clipping130890.mov", 
  ...
  "Did you notice or experience discrimination of Asian people living in Chicago?": { 
    id: 64, 
    category: "Activism", 
    videoFile: "V1-0078_Ashraf_Full_Interview_Clipping134005.mov", 
  ...
  "How did you cope with racism and discrimination professionally or otherwise?": { 
    id: 65, 
    category: "Activism", 
    videoFile: "V1-0080_Ashraf_Full_Interview_Clipping135490.mov", 
  ...
  "How did the political or global relationship between the U.S. and India impact your life? How did it impact how you were treated by Americans in general?": { 
    id: 66, 
    category: "General", 
    videoFile: "V1-0082_Ashraf_Full_Interview_Clipping141205.mov", 
  ...
  "Do you participate in cultural or religious activities?": { 
    id: 67, 
    category: "Social Life", 
    videoFile: "V1-0084_Ashraf_Full_Interview_Clipping145085.mov", 
...
const MARIAMMA_QUESTIONS = {
  "What is your name?": {
    id: 1,
    category: "Demographics",
    videoFile: "V1-0001_Mariamma_Full_Interview_Clipping00007033.mov",
    transcript: "My name is Mariama Thomas."
  },
  "Do you have any siblings?": {
    id: 2,
    category: "Demographics",
    videoFile: "V1-0002_1 and 2 Mariamma00007643.mov",
  ...
  "Who is in your family?": {
    id: 3,
    category: "Demographics",
    videoFile: "V1-0007_Mariamma 3 of 5_00191809.mov",
  ...
  "What do you enjoy doing? What do you do for fun?": {
    ...
    videoFile: "V1-0009_Mariamma 3 of 5_00194163.mov",
  ...
  "Are you religious? If so, what is your religion?": {
    id: 5,
    category: "Demographics",
    videoFile: "V1-0011_Mariamma 3 of 5_00196134.mov",
  ...
  "Where and when were you born?": {
    id: 6,
    category: "Demographics",
    videoFile: "V1-0009_Mariamma_Full_Interview_Clipping00007042.mov",
  ...
  "What is your native language ?": {
    id: 7,
    category: "Demographics",
    videoFile: "V1-0013_Mariamma 3 of 5_00199350.mov",
  ...
  "Do you have a spouse or a life partner?": {
    id: 8,
    category: "Demographics",
    videoFile: "V1-0014_Mariamma_Full_Interview_Clipping00009581.mov",
  ...
  "What language did you speak with your children?": {
    ...
    videoFile: "V1-0015_Mariamma 3 of 5_00200447.mov",
  ...
  "When did you come to USA ? When did you meet your husband?": {
    id: 10,
    category: "Arrival",
    videoFile: "V1-0016_Mariamma_Full_Interview_Clipping00010105.mov",
  ...
  "What is your education? What did you study?": {
    id: 11,
    category: "Early Life",
    videoFile: "V1-0017_Mariamma 3 of 5_00202992.mov",
  ...
  "How did you meet your spouse? How did you meet your husband?": {
    id: 12,
    category: "Family Life",
    videoFile: "V1-0018_Mariamma_Full_Interview_Clipping00010952.mov",
  ...
  "What was your life like in India? How did you come to the United States?": {
    id: 13,
    category: "Early Life",
    videoFile: "V1-0022_Mariamma 3 of 5_00209225.mov",
  ...
  "Where do you live currently? Where do you live now?": {
    id: 14,
    category: "Demographics",
    videoFile: "V1-0022_Mariamma_Full_Interview_Clipping00013300.mov",
  ...
  "Do you have siblings? Who did you grow up with? What did you do when you were young?": {
    id: 15,
    category: "Early Life",
    videoFile: "V1-0024_Mariamma 3 of 5_00213663.mov",
  ...
  "What did you do for a living or what job or career did you spend the majority of your life working in?": {
    id: 16,
    category: "Career",
    videoFile: "V1-0025_Mariamma_Full_Interview_Clipping00013801.mov",
  ...
  "How would you compare your experience in Iowa with living in the other parts of the US?": {
    id: 17,
    category: "History",
    videoFile: "V1-0026_Mariamma 3 of 5_00216633.mov",
  ...
  "So tell me about life in India and then also how did you come to the US?": {
    id: 18,
    category: "Early Life",
    videoFile: "V1-0027_Mariamma_Full_Interview_Clipping00014311.mov",
  ...
  "Did you encounter any instances of racism or discrimination? And how did you cope with these challenges? So tell me about some of your own personal experiences.": {
    id: 19,
    category: "Activism",
    videoFile: "V1-0028_Mariamma 3 of 5_00228719.mov",
  ...
  "When did you first arrive to the Midwest?": {
    id: 20,
    category: "Arrival",
    videoFile: "V1-0034_Mariamma_Full_Interview_Clipping00024813.mov",
  ...
  "please tell me about your journey to the Midwest.": {
    id: 21,
    category: "History",
    videoFile: "V1-0036_Mariamma_Full_Interview_Clipping00027202.mov",
  ...
  "When and why did you move to Iowa ?": {
    id: 22,
    category: "History",
    videoFile: "V1-0042_Mariamma_Full_Interview_Clipping00041099.mov",
  ...
  "What is your citizenship story? When did you receive it?": {
    id: 23,
    category: "History",
    videoFile: "V1-0044_Mariamma_Full_Interview_Clipping00043577.mov",
  ...
  "What was your feeling about the US? Did you want to come? When you came? Did you intend to stay or to leave?": {
    id: 24,
    category: "Arrival",
    videoFile: "V1-0046_Mariamma_Full_Interview_Clipping00044229.mov",
  ...
  "How did you come to the US and why did you move to the different places you went?": {
    id: 25,
    category: "History",
    videoFile: "V1-0048_Mariamma_Full_Interview_Clipping00050957.mov",
  ...
  "What did you expect your life would be like in the US or in Iowa? Did the reality match your expectations?": {
    id: 26,
    category: "Arrival",
    videoFile: "V1-0054_Mariamma_Full_Interview_Clipping00058910.mov",
  ...
  "How are you treated by other Americans once you were in the US?": {
    id: 27,
    category: "Social Life",
    videoFile: "V1-0056_Mariamma_Full_Interview_Clipping00063106.mov",
  ...
  "Did you encounter any other instances of racism or discrimination?": {
    id: 28,
    category: "Activism",
    videoFile: "V1-0058_Mariamma_Full_Interview_Clipping00064657.mov",
  ...
  "Describe your initial experiences upon arriving in the United States.": {
    id: 29,
    category: "Arrival",
    videoFile: "V1-0060_Mariamma_Full_Interview_Clipping00070651.mov",
  ...
  "How did you feel as you started the journey to the US?": {
    id: 30,
    category: "Arrival",
    videoFile: "V1-0062_Mariamma_Full_Interview_Clipping00074333.mov",
  ...
  "What brought about subsequent moves?": {
    id: 32,
    category: "History",
    videoFile: "V1-0066_Mariamma_Full_Interview_Clipping00080181.mov",
  ...
  "What kind of help did you need in the early years here? Who helped you?": {
    id: 33,
    category: "Social Life",
    videoFile: "V1-0068_Mariamma_Full_Interview_Clipping00082600.mov",
  ...
  "Did you encounter any instances of racism or discrimination, and how did you cope withthese challenges?": {
    id: 34,
    category: "Activism",
    videoFile: "V1-0071_Mariamma_Full_Interview_Clipping00151938.mov",
  ...
  "How did you navigate feelings of alienation or homesickness, and were there anysupport systems that helped you during difficult times? Were you expected tohelp out relatives back in India?": {
    id: 35,
    category: "Social Life",
    videoFile: "V1-0075_Mariamma_Full_Interview_Clipping00168768.mov",
  ...
  "What challenges did you face in securing or maintaining suitable Housing?": {
    id: 36,
    category: "Housing",
    videoFile: "V1-0077_Mariamma_Full_Interview_Clipping00173650.mov",
  ...
  "What impact did Indo-U.S. relations have on your life? Did they affect how you weretreated by other Americans?": {
    id: 37,
    category: "Social Life",
    videoFile: "V1-0079_Mariamma_Full_Interview_Clipping00179236.mov",
  ...
  "What challenges did you face in accessing Health care?": {
    id: 38,
    category: "Health",
    videoFile: "V1-0083_Mariamma_Full_Interview_Clipping00183026.mov",
  ...
  "what challenges do you face in social support, if if any?": {
    id: 39,
    category: "Social Life",
    videoFile: "V1-0087_Mariamma_Full_Interview_Clipping00191021.mov",
...
"Can you tell us an instance of good social support you had?": {
    id: 40,
    category: "Social Life",
    videoFile: "V1-0089_Mariamma_Full_Interview_Clipping00203590.mov",
  ...
  "So what challenges, if any, did you face with financial needs?": {
    id: 41,
    category: "Finances",
    videoFile: "V1-0091_Mariamma_Full_Interview_Clipping00206647.mov",
  ...
  "So what aspects of Indian culture, traditions or lifestyle did you miss the most while living in the US?": {
    id: 42,
    category: "Social Life",
    videoFile: "V1-0093_Mariamma_Full_Interview_Clipping00208882.mov",
  ...
  "How did you maintain a connection to your cultural roots, and did you participate in anycultural or religious activities?": {
    id: 43,
    category: "Social Life",
    videoFile: "V1-0097_Mariamma_Full_Interview_Clipping00218578.mov",
  ...
  "How did your perception of the \"American Dream\" evolve over time, and did it align withyour expectations?": {
    ...
    videoFile: "V1-0099_Mariamma_Full_Interview_Clipping00225180.mov",
  ...
  "What advice would you give to future generations of immigrants pursuing theirown American Dream?": {
    id: 45,
    category: "Reflections",
    videoFile: "V1-0101_Mariamma_Full_Interview_Clipping00229578.mov",
  ...
  "You know, did your initial idea of the American dream match what you experienced?": {
    id: 46,
    category: "Reflections",
    videoFile: "V1-0103_Mariamma_Full_Interview_Clipping00235034.mov",
...
const IDLE_VIDEOS = { 
  ashraf: "V1-0118_Ashraf_Full_Interview_Clipping201890.mov", 
  mariamma: "Mariamma_Idle.mov" 
};

const FALLBACK_VIDEOS = { 
  ashraf: ["V1-0114_Ashraf_Full_Interview_Clipping201490.mov", "V1-0121_Ashraf_Full_Interview_Clipping202405.mov"], 
  mariamma: [] 
};

// HELPER: Assuming videos are in public/videos/[person]/answers/
const getVideoUrl = (person, videoFile) => `/videos/${person}/answers/${videoFile}`;
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '30px', flex: 1, padding: '10px 40px 30px 40px', overflow: 'hidden' }}>
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100%' }}>
          <div style={{ backgroundColor: '#000', borderRadius: '16px', overflow: 'hidden', aspectRatio: '16/9', position: 'relative' }}>
            <video
              ref={videoRef}
              key={currentResponse ? currentResponse.videoFile : IDLE_VIDEOS[person]}
...
const App = () => {
  ...
  const handleAskQuestion = (person, directQuestion = null) => {
    ...
    setTimeout(() => {
      ...
      if (matchedKey && questions[matchedKey]) {
        ...
        setCurrentCategory(matchedData.category); // Update category on success
      } else {
        ...
        setCurrentResponse({ question: "I don't have a direct answer.", id: null, videoFile: randomFallback, person, isFallback: true });
  ...
  const getSuggestedTopics = () => {
    ...
    // Combine them, ensuring we have exactly 5, prioritizing same category
